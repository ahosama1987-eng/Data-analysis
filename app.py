...
with st.sidebar:
    ...
    uploaded = st.file_uploader(
        "Upload CSV or Excel",
        type=["csv", "xlsx"],
        help="CSV or Excel (multi-sheet). Files over 200 MB: run with --server.maxUploadSize=500",
...
if uploaded is None and not use_sample:
    ...
    <div style="text-align:center;padding:48px 24px 20px">
        <div style="font-size:3rem;margin-bottom:14px;filter:drop-shadow(0 0 24px {PBI_ACCENT})">⬛</div>
        <div style="font-size:1.4rem;font-weight:800;color:{PBI_WHITE};margin-bottom:8px;letter-spacing:-0.02em">
            DataVision Pro
        </div>
