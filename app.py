...
if uploaded is None and not use_sample:
    st.markdown(f"""
    <div style="text-align:center;padding:40px 24px 12px">
        <div style="font-size:2.5rem;margin-bottom:10px">&#x26AB;</div>
        <div style="font-size:1.2rem;font-weight:700;color:{PBI_WHITE};margin-bottom:5px">DataVision Pro</div>
        <div style="font-size:0.82rem;color:{PBI_MUTED};max-width:460px;margin:0 auto">
            Power BI-style analytics. Upload a CSV or Excel file in the sidebar, or load the demo dataset.
        </div>
    </div>
    <div class="dv-welcome-grid">
        <div class="dv-welcome-card"><div class="dv-welcome-icon">&#x1F4C2;</div>
            <div class="dv-welcome-title">Upload Any File</div>
            <div class="dv-welcome-desc">CSV or Excel — 100 MB+ with chunked loading</div></div>
        <div class="dv-welcome-card"><div class="dv-welcome-icon">&#x1F4CA;</div>
            <div class="dv-welcome-title">15+ Chart Types</div>
            <div class="dv-welcome-desc">Bar, Line, Scatter, Treemap, Donut, Pareto &amp; more</div></div>
        <div class="dv-welcome-card"><div class="dv-welcome-icon">&#x1F52E;</div>
            <div class="dv-welcome-title">AI Forecasting</div>
            <div class="dv-welcome-desc">Time-series forecasting with confidence bands</div></div>
        <div class="dv-welcome-card"><div class="dv-welcome-icon">&#x1F916;</div>
            <div class="dv-welcome-title">AI Chat Analyst</div>
            <div class="dv-welcome-desc">Ask in English or Arabic</div></div>
        <div class="dv-welcome-card"><div class="dv-welcome-icon">&#x1F9F9;</div>
            <div class="dv-welcome-title">Data Cleaning</div>
            <div class="dv-welcome-desc">Duplicates, missing values, renames</div></div>
        <div class="dv-welcome-card"><div class="dv-welcome-icon">&#x1F4E4;</div>
            <div class="dv-welcome-title">Export Center</div>
            <div class="dv-welcome-desc">CSV, Excel, and interactive charts</div></div>
    </div>""", unsafe_allow_html=True)
    st.stop()
